...
import io
from functions_monthly_m62 import *
...
if __name__ == '__main__':
    ...
    if username.lower()[1] == 'u':
        props['cod_job']="UM62MLOADBANKRUPTCY"
    elif username.lower()[1] == 'b' :
        props['cod_job']="BM62MLOADBANKRUPTCY"
    elif username.lower()[1] == 'p':
        props['cod_job']="PM62MLOADBANKRUPTCY"
    print(props)
    ...
    props["monthly_partition"]=last_work_day+'0000' 
    props["last_month_working_day_0000"]=last_work_day+'0000'
    props["last_month_working_day_0001"]=last_day_previous_month+'0001'
