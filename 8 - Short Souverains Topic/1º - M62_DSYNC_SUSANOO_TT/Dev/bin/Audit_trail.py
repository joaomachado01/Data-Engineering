...
def enrichir_dico_variable_values( spark, props , dicoTable , traitement, max_col_id   ):
    ...
    if traitement =='insert_partition_hadoop':
        ...
        dico_df_Values["vls_message"] = traitement 
        dico_df_Values["int_reject_line"] = None
    elif traitement == 'target_table_creation_ok_hadoop':
        print('# traitement type ', traitement)
        dico_df_Values["flg_log"]     = "I"
        dico_df_Values["cod_treatment"] = "C"
        dico_df_Values["vls_message"] = traitement 
        ...
        dico_df_Values["int_reject_line"] = None
        return dico_df_Values, max_col_id
    elif traitement == 'drop_working_table_hadoop':
        print('# traitement type ', traitement)
        dico_df_Values["flg_log"] = "I"
        dico_df_Values["cod_treatment"] = "DT"
        dico_df_Values["vls_message"] = traitement 
        dico_df_Values["int_reject_line"] = None
        return dico_df_Values, max_col_id
    elif traitement == 'insert_to_working_hadoop':
        print('# traitement type ', traitement)
        dico_df_Values["flg_log"]       = "I"
        dico_df_Values["cod_treatment"] = "C"
        dico_df_Values["vls_message"] = traitement
        dico_df_Values["int_reject_line"] = None
        return dico_df_Values, max_col_id
    elif traitement == 'insert_to_temporary_oracle':
        print('# traitement type ', traitement)
        dico_df_Values["flg_log"]       = "I"
        dico_df_Values["cod_treatment"] = "C"
        dico_df_Values["vls_message"] = traitement
...
def construct_tmp_values_for_audit_trail( start_time , dfCount , props  ):
    ...
    dicoTable['cod_file']                 =  props['HiveTabel']
