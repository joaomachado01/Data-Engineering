...
|==================================================|
|         CODE Name: Main.py                       | 
|   PURPOSE: Main code to Load EXTERNAL RATINGS    |
|    Table For Triggers on Financial State         |
|=========|==========|====================|========|
| Version |    Date  |       author       |        |
|   v1.0  | 20210326 |    Joao Machado    | Amexio |
|=========|==========|====================|========|
"""
...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder.appName('Create table tbl_sqr_deg_not_ext').enableHiveSupport().getOrCreate())
    ...
    if username.lower()[1] == 'u':
        props['cod_job']="UM24DCALCEXTRATDOWN"
    elif username.lower()[1] == 'b' :
        props['cod_job']="BM24DCALCEXTRATDOWN"
    elif username.lower()[1] == 'p':
        props['cod_job']="PM24DCALCEXTRATDOWN"
    print(props)
    ...
    for table in tables:
        ...
        ins_query, ins_rows, props, delete_statement1, delete_statement2 = Read_insert_parameters(spark, props['table_ins_file'],table,props, create_query_temp, props['query_hql'])
